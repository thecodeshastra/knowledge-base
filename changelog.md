...
- Fixed baseurl to publish on github.
...
- Fixed docs explicitly set docs path for CI/CD and updated docker volumes
- Initial configuration of docusaurus and folder structure.
- Initial commit
